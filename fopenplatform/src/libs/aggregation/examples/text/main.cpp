...
int main(int argc, char *argv[])
{
    ...
    Aggregation::Aggregate *obj5 = new Aggregation::Aggregate;
    obj5->add(new IComboEntry("Entry with text 1 , 2, 3"));
    obj5->add(new IText1("this is text1"));
    obj5->add(new IText2("This is text2"));
    obj5->add(new IText3("This is test 3"));
    ...
    w.add(Aggregation::query<IComboEntry>(obj5));
    w.show();
    return app.exec();
}
