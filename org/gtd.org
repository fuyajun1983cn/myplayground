...
*** ☛ TODO 物理层                                                         :802.11ac学习:
** wpa_supplicant持续学习
*** 研究use_p2p_group_interface=1选项的支持
*** p2p协商时Channel的选择
...
* Daily GTD [1/3]
** ☛ TODO [#C] IW源码学习
** ☛ TODO [#C] 阅读Emacs Plugin程序设计 [9/10]
...
** 整理Android笔记
*** WiFi Framework
** 分析一下CFG80211DRV_P2pClientConnect流程
** Sniffer Mode
