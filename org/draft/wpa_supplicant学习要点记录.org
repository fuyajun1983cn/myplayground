...
*** =struct wpa_supplicant= 
        #+BEGIN_SRC plantuml :exports both :file ./images/2016/2016081220.png :cmdline -charset UTF-8
          @startuml
...
*** 主要流程分析
**** hostapd初始化过程
          #+BEGIN_SRC plantuml :exports both :file ./images/2016/2016072902.png :cmdline -charset UTF-8
            @startuml
            autonumber 
            actor User
...
**** =hostapd_global_init=
           #+BEGIN_SRC plantuml :exports both :file ./images/2016/2016080901.png :cmdline -charset UTF-8
             @startuml
             start
