...
*** ✔ DONE 准备ZTE编译7668驱动事宜                                   :Project:
    CLOSED: [2016-09-12 周一 18:50] SCHEDULED: <2016-09-08 周四>
    CLOCK: [2016-09-09 周五 11:29]--[2016-09-09 周五 11:52] =>  0:23
    - 已经拿到代码，先在本机上自行编译一版
Added: [2016-09-08 周四 11:20]
*** ✔ DONE 基础特性部分—— 1 ~ 10章
    CLOSED: [2016-09-17 周六 18:00] SCHEDULED: <2016-09-17 周六> DEADLINE: <2016-09-30 周五>
    CLOCK: [2016-09-17 周六 16:40]--[2016-09-17 周六 18:01] =>  1:21
    CLOCK: [2016-09-17 周六 13:47]--[2016-09-17 周六 13:55] =>  0:08
*** ✔ DONE WIFI MAC TXRX
    CLOSED: [2016-09-21 三 19:25] SCHEDULED: <2016-08-31 周三> DEADLINE: <2016-09-23 五>
     CLOCK: [2016-09-19 一 21:59]--[2016-09-20 二 00:19] =>  2:20
     CLOCK: [2016-09-08 周四 15:14]--[2016-09-08 周四 16:43] =>  1:29
     - Next Action:
       阅读代码，把TX/RX的调用流程记录下来
*** ✔ DONE 高级特性 —— 11 ~ 20章
    CLOSED: [2016-09-23 五 10:15] DEADLINE: <2016-09-24 周六> SCHEDULED: <2016-09-19 周一>
*** ✔ DONE Miracast测试过程中搜索不到手机设备                        :Project:
   CLOSED: [2016-09-23 五 18:10] SCHEDULED: <2016-09-14 周三>
    在某次连接失败后，出现TV搜索不到手机设备。
Added: [2016-09-14 周三 13:20]
*** ✔ DONE 编写网络驱动示例程序                                        :Study:
   CLOSED: [2016-09-27 二 16:15] DEADLINE: <2016-09-30 五> SCHEDULED: <2016-09-26 一>
    - [X] 普通网络驱动
    - [X] 基于mac80211的网络驱动
Added: [2016-08-31 周三 20:25]
*** ✔ DONE mt7601 Kernel Panic的问题                                 :Project:
   CLOSED: [2016-09-30 五 14:30]
...
**** 本周必达目标(W39~W40) [4/4]
     - [X] 完成CWAP第二章的学习
     - [X] mac80211网络驱动程序编写
     - [X] p2p连接过程中wpa_supplicant接口实例的变更过程
     - [X] 完成设计模式的初期学习
** 10月[15/15]
*** ✘ CANCELED 网络课程——计算机原理                                    :Study:
   CLOSED: [2016-10-02 日 22:55] SCHEDULED: <2016-09-19 周一>

Added: [2016-09-04 周日 21:35]
*** ✔ DONE 第三章 & 第四章 ——递归
    CLOSED: [2016-10-03 一 05:35] DEADLINE: <2016-10-09 周日> SCHEDULED: <2016-09-26 周一>
*** ✔ DONE [#C] =org.el= 
    CLOSED: [2016-10-03 一 11:00]
    - State "✔ DONE"     from "☛ TODO"     [2016-10-03 一 10:55]
    ...
    :PROPERTIES:
    :Effort:   8:00
    :LAST_REPEAT: [2016-10-03 一 10:58]
    :END:
    - 406行
*** ✔ DONE 第五章 & 第六章 —— 栈
    CLOSED: [2016-10-10 一 09:15] DEADLINE: <2016-10-29 六> SCHEDULED: <2016-10-10 一>
*** ✔ DONE 深入分析WPA状态机实现源码                                   :Study:
   CLOSED: [2016-10-10 一 18:00] DEADLINE: <2016-10-29 周六> SCHEDULED: <2016-09-19 周一>
    - 目录
      弄清状态机实现的细节，产生详细文档。
    - EAP框架源码
      Done
    - EAP Authenticator/Supplicant代码分析
      EAPOL State machine, 从代码实现的角度来看，eapol是eap的一个扩展。
Added: [2016-09-08 周四 17:25]
*** ✔ DONE configfs接口研究
    CLOSED: [2016-10-10 一 18:00]
*** ✔ DONE 学习DBUS                                                    :Study:
   CLOSED: [2016-10-11 二 21:15] SCHEDULED: <2016-10-09 日> DEADLINE: <2016-10-22 六>
    了解Python下使用DBUS通信，能够编写基本的程序
    - [X] Dbus基本认识
    - [X] Python Dbus API的基本使用
Added: [2016-09-09 周五 11:45]
*** ✘ CANCELED 802.11常见帧格式深入研究
    CLOSED: [2016-10-12 三 13:45]
**** Beacon帧
     CHANNEL_SWITCH_ANNOUNCEMENT
**** CSA(Channel Switch Announcement
     eCSA
*** ✔ DONE 【创维mstar平台】──播放过程中，出现Beacon Lost            :Project:
   CLOSED: [2016-10-12 三 18:05]
   现象： 播放视频的过程中，出现了断开重连打印
Added: [2016-09-19 一 18:15]
*** ✔ DONE [#B] 查看公版分支上的修改                                   :Study:
    CLOSED: [2016-10-17 一 09:40] SCHEDULED: <2016-10-10 一>
    - State "✔ DONE"     from "☛ TODO"     [2016-10-17 一 09:40]
    ...
    :PROPERTIES:
    :Effort:   8:00
    :LAST_REPEAT: [2016-10-17 一 09:38]
    :END:
...
*** ✔ DONE 第七章  —— 队列
    CLOSED: [2016-10-24 一 13:55]
*** ✔ DONE [#A] Module FSM
     CLOSED: [2016-10-25 周二 09:40] SCHEDULED: <2016-10-09 日> DEADLINE: <2016-10-14 五>

*** ✔ DONE mac80211源码分析                                            :Study:
    CLOSED: [2016-10-31 周一 09:50]
    - Action: 制定研究计划
    - [X] 研究hwsim源码，编写一个基于mac80211的网络驱动程序
    - [X] 研究mac80211的源码，整理出学习笔记

*** ✘ CANCELED 研究emacs输入法框架
     CLOSED: [2016-10-31 周一 09:50] DEADLINE: <2016-10-29 六> SCHEDULED: <2016-10-10 一>
*** ✔ DONE 本月已达成目标
    CLOSED: [2016-10-31 周一 10:00]
**** 本周必达目标(W40)
...
**** 本周必达目标(W43)
      ...
      - [X] 完成字符串与数组面试题
      - [X] 7668 SCAN流程学习
      - [X] 梳理mac80211大体框架，制定下一步学习计划
** 11月[5/5]
*** ✔ DONE 在发送Association Request之前禁用一些HT/VHT的速率
     CLOSED: [2016-11-02 周三 18:00] SCHEDULED: <2016-09-19 周一>
     http://lists.infradead.org/pipermail/hostap/2015-October/034018.html

*** ✔ DONE 编写一个Chrome Plugin，记录自己收藏的网址
    CLOSED: [2016-11-03 周四 16:15]
*** ✔ DONE 域名续费
     CLOSED: [2016-11-03 周四 16:20] DEADLINE: <2016-11-28 一> SCHEDULED: <2016-11-01 二>
*** ✔ DONE [#B] SCAN                                            :7668学习:Study:
     CLOSED: [2016-11-03 周四 16:20] DEADLINE: <2016-10-29 周六> SCHEDULED: <2016-10-26 周三>
*** ✔ DONE 了解晶元制程
...
** 12月[2/2]
*** ✔ DONE [#C] 整理以前的学习笔记 [4/8]
     CLOSED: [2016-12-08 周四 14:35]
