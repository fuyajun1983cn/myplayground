...
{
    //设置工程目录
    putenv("PROJECT_PATH=/home/fuyajun/myplayground/qt/morrowland/morrowland/lesson07");
 ...
 //   glBlendFunc(GL_SRC_ALPHA, GL_ONE_MINUS_SRC_ALPHA);	// Set The Blending To A Nice 50/50 Mode
    ...
    if (tex1.loadTexture2D("texture/image1.bmp")) {
...
#if 1
    if (tex2.loadTexture2D("texture/lightmap.bmp")) {
